...
system.mem_ctrl.dram = DDR3_1600_8x8(range=AddrRange('16MiB'),
                                     in_addr_map=False)
system.mem_ctrl.nvm = NVM_2400_1x64(range=AddrRange('16GB'))

system.mem_ctrl.dram.tREFI = "200"
system.mem_ctrl.dram_cache_size = "16MiB"
system.mem_ctrl.orb_max_size = "1024"
system.mem_ctrl.crb_max_size = "16"
