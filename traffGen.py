...
system.mem_ctrl.mem = MemTypes[options.dram](range=AddrRange(start = '0', end = '256MB', masks = [1 << 6], intlvMatch = 0))
system.mem_ctrl.mem_2 = MemTypes[options.dram](range=AddrRange(start = '0', end = '256MB', masks = [1 << 6], intlvMatch = 1))
...
system.mem_ctrl.mem.tREFI = "2000"
system.mem_ctrl.mem_2.tREFI = "2000"
