...
system.generator = PyTrafficGen(max_outstanding_reqs = 36)


system.farMem_ctrl = MemCtrl()

system.farMem_ctrl.dram = HBM_1000_4H_1x128(range=AddrRange('4GB'))
# system.farMem_ctrl.dram.page_policy = 'close_adaptive'


# system.generator.port = system.farMem_ctrl.port
...
system.membus.forward_latency = options.xbarLatency
