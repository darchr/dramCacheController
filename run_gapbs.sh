...
if [! -d results_gapbs_$1_$2_$3]; then
     mkdir -p results_gapbs_$1_$2_$3;
fi
...
do
echo $bm
build/X86_MESI_Two_Level/gem5.opt -re --outdir results_gapbs_$1_$2_$3/synthetic_22/$bm/ configs-gapbs/run_gapbs.py ../vmlinux-4.9.186 ../gapbs.img $1 $3 $2 $bm 1 22 &
done
