...
build/X86_MESI_Two_Level/gem5.opt -re  --outdir=newResults/rambusTagPr/1GB_8GB_g22_nC/NPB/bt      configs-npb-gapbs/restore_both.py   bt.C.x  RambusTagProbOpt 1 0 0 0 &
...
build/X86_MESI_Two_Level/gem5.opt -re  --outdir=newResults/rambusTagPr/1GB_8GB_g22_nC/NPB/sp      configs-npb-gapbs/restore_both.py   sp.C.x  RambusTagProbOpt 1 0 0 0 &
...
build/X86_MESI_Two_Level/gem5.opt -re  --outdir=newResults/rambusTagPr/1GB_8GB_g22_nC/GAPBS/bfs   configs-npb-gapbs/restore_both.py   bfs-22  RambusTagProbOpt 1 0 0 0 &
...
build/X86_MESI_Two_Level/gem5.opt -re  --outdir=newResults/rambusTagPr/1GB_8GB_g22_nC/GAPBS/tc    configs-npb-gapbs/restore_both.py   tc-22   RambusTagProbOpt 1 0 0 0 &
